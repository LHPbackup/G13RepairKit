...
![](./G13RepairKit_images/picture4a.jpg)

ポスト投函でのお届けが出来るよう、ジョイスティックカバーを外してお送りしております。

ジョイスティックの軸にジョイスティックカバーを奥までしっかり押し込みます。（2mm程度の隙間が空く）  
...
コントロールパネル→ハードウエアとサウンド→デバイスとプリンター(Win11は右クリック→開く)→HID準拠ゲームコントローラー(右クリック)→ゲームコントローラーの設定→プロパティ→設定タブ→調整の手順でデバイスの調整ウィザードを開始し、ジョイスティックの校正を行ってください。  
<br>
<br>
<br>
