...
![](./G13RepairKit_images/picture4.jpg)

ポスト投函でのお届けが出来るよう、ジョイスティックカバーを外してお送りしております。

ジョイスティックの軸にジョイスティックカバーを奥までしっかり押し込みます。（1mm程度の隙間が空く）
...
基板に刺さっているコネクターを慎重に外します。（**絶対にコードを引っ張らないように！**）  
...
![](./G13RepairKit_images/picture6.jpg)
...
![](./G13RepairKit_images/picture7.jpg)

ねじを2本締め込みます。  
注意：ねじは最後、均等に締めこんでください。1本だけを先に締めこむと基板が傾いてしまいます。  
コネクターを元の色の順番になるよう差し込みます。
<br>
<br>
<br>

### ４．ジョイスティック下押し部品のリプレース

![](./G13RepairKit_images/picture9.jpg)

ジョイスティック下押し部品のねじを外します。黒い小部品も併せて取り外します。    
<br>
<br>
<br>
...
コントロールパネル→ハードウエアとサウンド→デバイスとプリンター→HID準拠ゲームコントローラー→ゲームコントローラーの設定→プロパティの手順でジョイスティックの校正を行ってください。  
<br>
